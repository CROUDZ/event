...
export default function Home() {
  ...
  // Store the actual IP separately
  const actualServerIP = "runkko.earthlink-minecraft.fr:25565";
  ...
  const qcmQuestions = useMemo(
    () => [
      ...
      {
        question:
          "Pour qui Zenith999 a t il voté lors des dernières élections présidentielles :",
  ...
  const handleQcmAnswer = useCallback(
    (idx: number) => {
  ...
  // Fix: Only set copied state, don't change serverIP
  const copyToClipboard = useCallback(async () => {
    if (serverIP === actualServerIP) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
          ...
          <div className="flex justify-center items-center flex-col text-center z-10 px-4">
            <m.div
              ...
              transition={{
                ...
                type: performanceSettings.enableComplexAnimations
                  ? "spring"
                  : "tween",
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p>
                Pour célébrer tes 100 abonnés, nous avons préparé quelque chose
                de très spécial ! 🎮
              </p>
              <p>
                Une enquête mystérieuse t'attend, et si tu réussis à la
                résoudre, tu découvriras un serveur Minecraft exclusif où une
                surprise t'attend...
              </p>
            ...
            {!qcmDone ? (
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-700 mb-2">
                  Tu peux maintenant accéder au serveur Minecraft grâce à cette
                  IP : <span className="font-mono font-bold">{serverIP}</span>
                </p>
                <p className="text-sm md:text-base text-gray-700 mb-2">
                  Et grâce au modpack{" "}
                  <span className="font-bold">Demande le à Goldmine2011</span>
                </p>
              </m.div>
            )}
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                ...
                >
                  {/* Always show the actual IP if QCM is done */}
                  {serverIP === actualServerIP ? actualServerIP : serverIP}
                </m.div>
                ...
                <m.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  disabled={serverIP !== actualServerIP}
                  aria-label="Copier l'IP du serveur"
                >
                  {copied ? (
                    <Check className="w-5 md:w-6 h-5 md:h-6 text-green-300" />
                  ) : (
                    <Copy className="w-5 md:w-6 h-5 md:h-6 text-white" />
                  )}
                </m.button>
              </div>
