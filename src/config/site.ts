...
export const siteConfig = {
  ...
  eventDescription: {
    line1: "Pour célébrer tes 100 abonnés, nous avons préparé quelque chose de très spécial ! 🎮",
    line2: "Une enquête mystérieuse t'attend, et si tu réussis à la résoudre, tu découvriras un serveur Minecraft exclusif où une surprise t'attend...",
